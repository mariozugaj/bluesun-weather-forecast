...
export const HumidityGraph = ({
  ...
  const handleTooltip = datum => event => {
    ...
    return showTooltip({
      tooltipData: d,
      tooltipLeft: xLoc,
      tooltipTop: yScale(d.humidity * 100),
    });
  };
    ...
    <figure className="graph-wrapper">
      <svg width={width} height={height}>
        ...
        <Group left={margin.left} top={height - 4}>
          <text fontSize={12}>Humidity %</text>
        </Group>
        />
      </svg>
      {tooltipOpen && (
...
export default withTooltip(HumidityGraph, { style: { position: "relative" } });
